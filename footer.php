...
<footer>
	...
	<div class="footer__logos">
		<ul class="container">
			...
			<li><a target="new" href="#"><img width="112px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/logo_emsa.png" alt="Logo Emsa"></a></li>
			<li><a target="new" href="#"><img width="70px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/logo_fun_iladiba.png" alt="Logo Fundación Iladiba"></a></li>
			<li><a target="new" href="#"><img width="218px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/logo_iladiba.png" alt="Logo Iladiba"></a></li>
			<li><a target="new" href="#"><img width="202px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/logo_cursos_iladiba.png" alt="Logo Cursos Iladiba"></a></li>
			<li><a target="new" href="#"><img width="161px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/logo_salud_hoy.png" alt="Logo Salud Hoy"></a></li>
		</ul>
	</div>
		...
		<div class="container">
			<div class="six columns">
				...
				<ul class="copyright__contact">
					<li>
						<img width="21px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/icon_map.png" alt="Icon Map">
						<p>Calle 30A No. 6- 22<br>Bogotá, Colombia</p>
					</li>
					<li>
						<img width="22px" src="<?php bloginfo('template_url' ); ?>/library/images/footer/icon_tel.png" alt="Icon Tel">
